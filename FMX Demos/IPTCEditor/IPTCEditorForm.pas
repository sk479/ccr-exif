...
begin
  { Fix up anchors and control widths (can't do it at design time perfectly due to the
    fact the scroll bar width in the macOS theme is thinner than in the Windows one).
  ...
  { TTabControl.Position = tpBottom doesn't work properly, so we implement our own
    bottom aligned tab style. I'm also not keen on the TTabControl style for macOS
